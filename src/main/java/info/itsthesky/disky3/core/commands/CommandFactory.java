...
public class CommandFactory {
    ...
    public ArrayList<ChannelType> parsePlaces(String[] places) {
        ...
        for (String place : places) {
            if (info.itsthesky.disky3.api.Utils.equalsAnyIgnoreCase(place, "server", "guild")) {
                types.add(ChannelType.TEXT);
            } else if (info.itsthesky.disky3.api.Utils.equalsAnyIgnoreCase(place, "dm", "pm", "direct message", "private message")) {
