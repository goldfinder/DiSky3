...
public class GuildBoosts extends ChangeablePropertyExpression<Guild, Number> {

    static {
        register(
                GuildBoosts.class,
                Number.class,
                "[discord] boost amount",
                "guild"
        );
    }
    ...
    public @NotNull String toString(@Nullable Event e, boolean debug) {
        return "boost amount of " + getExpr().toString(e, debug);
    }
