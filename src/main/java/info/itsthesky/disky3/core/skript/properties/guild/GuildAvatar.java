...
public class GuildAvatar extends ChangeablePropertyExpression<Guild, String> {
    ...
    public void change(Event e, Object[] delta, Bot bot, Changer.ChangeMode mode) {
        ...
        guild.getManager().setIcon(icon).queue(null, ex -> DiSky.exception(ex, info));
    }

    @Override
    protected String @NotNull [] get(@NotNull Event e, Guild @NotNull [] source) {
        return new String[] {source[0].getIconUrl()};
    }
