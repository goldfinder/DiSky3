...
public class CreateText extends WaiterEffect<TextChannel> {
    ...
    public boolean initEffect(Expression<?>[] exprs, int i, Kleenean kleenean, SkriptParser.ParseResult parseResult) {
        ...
        setChangedVariable((Variable<TextChannel>) exprs[3]);
    ...
    public void runEffect(Event e) {
        ...
        guild.createTextChannel(name).queue(this::restart);
    }
}
